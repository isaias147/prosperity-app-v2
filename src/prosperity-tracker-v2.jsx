...
const getDayIdx  = () => {
// Use today’s date string as seed so verse changes at midnight not by milliseconds
...
// Single consolidated save — done + reflection together
setCheckins(p => ({
…p,
[todayKey()]: {
…p[todayKey()],
...
…(currentRefl.trim() ? { reflection: currentRefl.trim() } : {})
}
}
}));
setCurrentRefl(””);
